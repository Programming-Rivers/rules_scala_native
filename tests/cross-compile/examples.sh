...
platforms=(
    ...
    "@toolchains_llvm_bootstrapped//platforms:linux_x86_64_gnu.2.42"
    ...
    "@toolchains_llvm_bootstrapped//platforms:none_wasm32"
    "@toolchains_llvm_bootstrapped//platforms:none_wasm64"
